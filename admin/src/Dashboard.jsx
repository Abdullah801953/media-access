    ...
    <div className="min-h-screen bg-gray-100">
      ...
      >
        ...
        <div className="p-4 border-t border-gray-700">
          <button
            onClick={logout}
            className="w-full text-left px-4 py-2 hover:bg-red-700 rounded flex items-center gap-2 transition-colors"
          >
            <svg
              className="w-5 h-5"
              fill="none"
                    ...
                    {filteredUsers.map((user) => (
                      <tr key={user.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 max-w-xs">
                          {user.message ? (
                            <div
                              className="text-sm text-gray-800 bg-green-50 border border-green-200 rounded-md p-2 h-20 overflow-auto max-w-xs break-words"
                              title={user.message}
                            >
                              {user.message}
                            </div>
